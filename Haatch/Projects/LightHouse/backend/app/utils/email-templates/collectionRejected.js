exports.collectionRejected = function (user, curator, collection) {
                ...
                <body>
                    <div class="col-12 pt-3 pb-3 banner">
                        <div class="container text-white">
                            <h2>Помоград - Ваш сбор отклонён</h2>
                        </div>
                    </div>
                        ...
                        <div class="p-3">
                            ...
                            <div class="mb-3 text-justify mt-3">
                              <span class="text-dark">
                                К сожалению ${curator} отклонил(а) Ваше приглашение и отказался(лась) стать куратором сбора "${collection}".
                                <br>
                                Попытайтесь связаться с ним/ней лично.
                                <br>
                                Вы так же можете попробовать выбрать другого куратора для Вашего сбора.
                                <br>
