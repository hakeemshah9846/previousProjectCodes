exports.otpVerified = function (name) {
                ...
                <body>
                    <div class="col-12 pt-3 pb-3 banner">
                        <div class="container text-white">
                            <h2>Добро пожаловать в Помоград!</h2>
                        </div>
                    </div>
                    <div class="container mt-3 mb-5">
                        <div class="p-3">
                            <div>Дорогой(ая) ${name},</div>
                            <div class="mb-3 text-justify mt-3">
                              <span class="text-dark">
                                Мы очень рады видеть вас в наших рядах!
                                <br>
                                Помните, не бывает слишком маленькой помощи: любой вклад важен и нужен.
                                <br>
                                Не забывайте следить за новостями обновлениями сборов чтобы знать как расходуются Ваши средства.
                              </span>
                              <br><br><br><br>
