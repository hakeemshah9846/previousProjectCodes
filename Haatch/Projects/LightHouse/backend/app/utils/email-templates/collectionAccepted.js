exports.collectionAccepted = function (user, curator, collection, permalink) {
                ...
                <body>
                    <div class="col-12 pt-3 pb-3 banner">
                        <div class="container text-white">
                            <h2>Помоград - Ваш сбор одобрен</h2>
                        </div>
                    </div>
                    <div class="container mt-3 mb-5">
                        <div class="p-3">
                            <div>Уважаемый(ая) ${user},</div>
                            <div class="mb-3 text-justify mt-3">
                              <span class="text-dark">
                                Рады сообщить вам, что ${curator} принял Ваше приглашение стать куратором сбора "${collection}".
                                <br>
                                На данный момент сбор уже активен и доступен по ссылке https://pomograd.ru/${permalink}.
                                <br>
                                Искренне Вас поздравляем, и желаем Вам дальнейших успехов!
                              </span>
                              <br><br><br><br>
