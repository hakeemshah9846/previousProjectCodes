...
const sqlQuery = `
INSERT INTO task_management.printer_papers (id, printer_id, paper_id, createdAt, updatedAt)
SELECT id, printer_id, paper_id,NOW(),NOW()
FROM printing_shop.dc_printerpaper;
`;
