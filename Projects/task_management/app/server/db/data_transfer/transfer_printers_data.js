...
const sqlQuery = `
INSERT INTO task_management.printers (id, name, status,color_type,cost, paper_support,createdAt,updatedAt)
SELECT id, printer_name, printer_status,printer_colortype, print_cost, paper_support,NOW(),NOW()
FROM printing_shop.dc_printers;
`;
