...
const sqlQuery = `
INSERT INTO task_management.prices (id, paperType, printerType,printOnesideBW,printTwosideBW, printOnesideC,printTwosideC,createdAt,updatedAt)
SELECT id, paperType, printerType,printOnesideBW,printTwosideBW, printOnesideC,printTwosideC,NOW(),NOW()
FROM printing_shop.dc_pricetable;
`;
