...
module.exports= function validatePrintCoverEditInput(data){
    ...
    console.log("Validation file reached........");
        ...
        data.print_cover_id= !isEmpty(data.print_cover_id) ? data.print_cover_id : '';
        ...
        data.print_cover_material= !isEmpty(data.print_cover_material) ? data.print_cover_material : '';    
          ...
          if (validator.isEmpty(data.print_cover_id)) {
            errors.print_cover_id = "print_cover_id field is required";
          }
