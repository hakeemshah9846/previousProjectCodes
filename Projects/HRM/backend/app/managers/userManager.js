  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      if (employment_information_flag === "true") {
        ...
        if (organization_user_flag == "true") {
          user_details["official_details.employee_id"] =
      ...
      if (organization_user_flag !== "true") {
        ...
        if (organization_details) {
          ...
          external_services.map((e) => {
            ...
            let status = e.status.toString();

            if (
              service_id === "64a3e8efaf6c697ec74d632b" &&
              status == "enabled"
            ) {
              zoho_flag = true;
        ...
        if (zoho_flag) {
          ...
          let client_id = organization_details.zoho_client_id;
          console.log("Client id : ", client_id);
          // let client_id = "1000.UUK8YFOIG0BOHX0TMI3NHMDJD28SRI";
          let client_secret = organization_details.zoho_client_secret;
          console.log("Client secret : ", client_secret);
          // let client_secret = "01dd2a184d67c05266dcb635a65b3505b863671245";
          let redirect_uri = organization_details.zoho_redirect_uri;
          ...
          let zoho_refresh_token = organization_details.zoho_refresh_token;
          console.log("Zoho refresh token : ", zoho_refresh_token);

          //Getting access_token using refresh_token for creating account
        
          console.log(
            "Access token url : ",
            `https://accounts.zoho.in/oauth/v2/token?refresh_token=${zoho_refresh_token}&client_secret=${client_secret}&client_id=${client_id}&redirect_uri=${redirect_uri}&grant_type=refresh_token&scope=ZohoMail.partner.organization.ALL`
          );
          ...
          let name1 = first_name + last_name;
          let name2 = name1.toLowerCase();
          var email_name_1 = name2 + uniqueNumber + "@pprplane.com";
          // var email_name = email_name_1.trim();
          var email_name = email_name_1.replace(/\s/g, "").trim();
          ...
          console.log("Zoho create account url : ",`https://mail.zoho.in/api/organization/${zoid}/accounts`);
          let account_response = await axios.post(
            `https://mail.zoho.in/api/organization/${zoid}/accounts`,
            {
              role: "member",
            ...
            console.log("Create user reached here...");
          ...
          //   const refreshToken =
          //     "1000.0545f41ff8c8d5a06ccc0fb6e808dd79.3a94fdc0e6fa5ff9c3fd2460787f30c5";
      ...
      if (saved) {
        ...
        if(zoho_flag) {
          response.zoho_email = email_name;
          response.zoho_password = password;
        }
        resolve(response);
        return;
      } else {
