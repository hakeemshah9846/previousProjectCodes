...
module.exports = async function validateEditOrganizationInput(data) {
    let errors = {};
...
//     errors.organization_id = "Organization id field is required";
//   }
  ...
  if(data.email) {
    ...
    if (validator.isEmpty(data.email)) {
      ...
      if (
        ...
        errors.email_unique = "Email must be unique";
      }
  ...
  if (!validator.isLength(data.industry, { min: 1, max: 30 })) {
    ...
    console.log("Reached end of Organization validation file....");
